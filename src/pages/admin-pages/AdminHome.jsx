    ...
    <div className=' w-full h-auto overflow-x-scroll scrollbar-none '>
        <table className=' w-full border'>
            ...
            <tr className='border-solid border-2'>
                ...
                <th className='border-solid border-2 border-gray-500'>Language</th>
                <th className='border-solid border-2 border-gray-500'>Description</th>
            ...
            <tbody>
                {
                    movies.map((movie)=>(
                        ...
                        <Link to="/Admin/EditMovie">
                            <td className='border-solid border-2 text-center  w-full h-full'><FaEdit /></td>
                        </Link>
                        <Link>
                            <td className='border-solid border-2 text-center'><FaTrash /></td>
                        </Link>
                    </tr>
                    ))
                }
